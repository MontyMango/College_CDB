...
public class bankAnalysis
{
    ...
    public void transactionAnalysis() throws IOException
    {
        ...
        while(done == false)
        {
            ...
            // If user picks 1, call listAllTransactions() method of the object of transactionAnalysis.
            if(choice == 1) tA.listAllTransactions();

            // If user picks 2, call listTransactions() method of the object of transactionAnalysis.
